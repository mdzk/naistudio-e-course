    ...
    <div id="nav-mobile">
        ...
        <div class="nav-mobile-wrepper">
            <ul class="text-center ">
                ...
                <li class="nav">
                    <a href="#cari-video" class="mx-auto">Cari Video</a>
                </li>
                <li class="nav">
                ...
                <li class="button mb-4">
                    <a href="javascript:" class="btn btn-border btn-nav">Masuk</a>
                </li>
                <li class="button">
                    <a href="javascript:" class="btn btn-color btn-nav btn-color-black">Daftar</a>
                </li>
                @endif
            </ul>
        </div>
                    ...
                    <div class="col-md-6 hero-des">
                        <div class="hero-des-wrapper">
                            ...
                            <div class="button content-2-effect hero-banner-effect-1">
                                <a href="" class="btn btn-lg btn-color btn-hero">Belajar Sekarang</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="button text-center">
                                        <a href="" class="btn btn-video">Lihat Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="content-grid">
                    <div class="banner-1-wrepper text-center">
                        <h1 data-video="2312" data-playlist="45">
                            ...
                            <div class="button">
                                <a href="" class="btn btn-lg btn-border btn-banner-1">Tampilkan Playlist</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="content-1-des">
                                    <div class="medium-title text-left">
                                        ...
                                        <div class="button button-content content-1-effect">
                                            <a href="" class="btn btn-lg btn-color btn-content-1 ">Lihat
                                            Selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="button btn-wrepper text-center">
                                        <a href="" class="btn btn-color btn-banner-3">Daftar Sekarang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
